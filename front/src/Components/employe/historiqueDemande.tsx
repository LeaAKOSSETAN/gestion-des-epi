...
export default function HistoriqueDemandes() {
  const demandes = [
    { date: "2025-06-10", epi: "Chaussures de sécurité", quantite: 1, statut: "Validée" },
    { date: "2025-06-05", epi: "Gants", quantite: 2, statut: "En attente" },
  ];

  return (
    <EmployeNavbar>
    <div className="bg-white p-6 rounded-lg shadow">
      <h2 className="text-xl font-semibold text-sky-900 mb-4">Historique des demandes</h2>
